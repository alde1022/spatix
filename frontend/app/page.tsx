...
// Dynamic import for map canvas (no SSR - uses browser APIs)
          ...
          <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[60] bg-white rounded-xl shadow-2xl p-6 max-w-md animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                value={savedUrl}
                readOnly
                className="flex-1 px-3 py-2 bg-slate-100 rounded-lg text-sm font-mono"
              />
              <button
            ...
            <a
              ...
              className="block text-center text-brand-600 hover:underline text-sm mt-3"
            >
              Open map →
            </a>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
          Maps in seconds.<br />
          <span className="text-brand-600">No GIS skills needed.</span>
        </h1>

        <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto">
          Drop any file → instant beautiful map → style → share.
          The simplest way to visualize and share geographic data.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto mt-20">
          <div className="text-center">
            ...
            <p className="text-slate-600 text-sm">
              GeoJSON, Shapefile, KML, GPX, CSV, and 15+ formats supported
            </p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-brand-100 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-slate-600 text-sm">
              Beautiful presets, custom colors, multiple basemaps
            </p>
          </div>
          <div className="text-center">
            <div className="w-12 h-12 bg-brand-100 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-slate-600 text-sm">
              Unique URLs, embeddable iframes, social previews
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mb-4">
                Perfect for AI agents. Create maps with a single POST request.
              </p>
              <pre className="bg-slate-800 p-4 rounded-lg text-sm text-slate-300 overflow-x-auto">
{`POST /api/map
{ "data": [[-122, 37], [-118, 34]], "title": "West Coast" }`}
              </pre>
              <Link href="/developers" className="inline-block mt-4 text-violet-400 hover:text-violet-300 text-sm font-medium">
                View API docs →
              </Link>
            </div>
          </div>
