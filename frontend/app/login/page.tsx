        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white border-2 border-slate-300 rounded-lg font-medium hover:bg-slate-50 hover:border-slate-400 transition-all disabled:opacity-50 text-slate-700"
            >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-slate-900 pr-10"
                  placeholder="••••••••"
                  required
                />
                <button
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-all disabled:opacity-50"
            >
