...
export default function LoginPage() {
  ...
  const handleSuccess = async (user: any) => {
    ...
    // Redirect to home instead of account (account needs backend update)
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white border-2 border-slate-300 rounded-lg font-medium hover:bg-slate-50 hover:border-slate-400 transition-all disabled:opacity-50"
              style={{ color: '#374151' }}
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-gray-900 rounded-lg font-medium text-white hover:bg-gray-800 transition-all disabled:opacity-50"
            >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 bg-white border border-slate-300 rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-3.5 py-2.5 pr-10 bg-white border border-slate-300 rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                />
                <button
                  type="button"
